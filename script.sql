...
Створила нову табличку з даними країни та перенесла дані з ненормалізованої таблиці infectious_cases
...
Створила нову нормалізовану табличку infectious_cases_norm та перенесла дані з ненормалізованої таблиці 
...
4. 	Побудувала колонки різниці в роках
